...
const carouselImages = importEducationImages(require.context('../images/nutrition', false, /\.(png|jpe?g|webp)$/));


const Nutrition = ({ languageType }) => {
