...
const CampaignSections = ({ languageType }) => {
  ...
  const content = {
    en: [
      ...
      { heading: 'Nutrition Drive', description: 'Sewa Bharti promotes proper nutrition through awareness programs, food distribution drives, and support for undernourished children and families.', route: '/proper-nutrition' },
    ],
    hi: [
      { heading: 'किशोरी विकास', description: 'सेवा भारती शिक्षा, जीवन कौशल प्रशिक्षण और भावनात्मक समर्थन के माध्यम से किशोरों के समग्र विकास पर ध्यान केंद्रित करता है, ताकि एक मजबूत भविष्य का निर्माण हो सके।', route: '/adolescent-development' },
      ...
      { heading: 'सुपोषण अभियान', description: 'सेवा भारती जागरूकता कार्यक्रमों, खाद्य वितरण अभियानों और कुपोषित बच्चों और परिवारों के लिए सहायता के माध्यम से उचित पोषण को बढ़ावा देता है।', route: '/proper-nutrition' },
    ],
  };
