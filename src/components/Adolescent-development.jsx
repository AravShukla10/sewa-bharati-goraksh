...
const carouselImages = importEducationImages(require.context('../images/adolescent', false, /\.(png|jpe?g|webp)$/));


const Adolescent = ({ languageType }) => {
  ...
  const content = {
    hi: {
      mainHeading: 'किशोर विकास',
      backButton: 'वापस जाएं',
    },
    en: {
      mainHeading: 'Adolescent Development',
      backButton: 'Back',
    }
  };
