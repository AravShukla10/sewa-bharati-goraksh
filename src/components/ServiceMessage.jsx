  ...
  const content = {
    en: {
      ...
      paragraphs: [
        ...
        `Nature also inspires us to serve. Sun, water, wind, trees, earth, everything always gives the message of giving. The country gives us everything, we should also learn to give something, taking inspiration from this, we can experience ultimate happiness by making our lives meaningful through service. In Hindu tradition, it is believed that by donating for the upliftment of the poor and the helpless, Goddess Lakshmi herself comes to the person and he always remains happy, healthy and long-lived.`,
        `Seva Bharti believes in three categories of service work. 
        i. Removing the need of a poor person, such as giving food to the hungry, water to the thirsty, medicine to the sick, education to the illiterate, is placed in the third category. 
        ii. Removing the needs of the suffering and deprived people and making them self-reliant and self-respecting is called the second category. 
        iii. Making efforts so that the person who is served today becomes self-reliant, self-respecting and the one who serves others tomorrow is called the first category. 
        Continuous efforts are made to ensure that most of the service works carried out by Sewa Bharti are of first class and that they bring about social change.`,
      ],
      categories: [
        {
    ...
    hi: {
      ...
      paragraphs: [
        ...
        `प्रकृति भी हमें सेवा करने की प्रेरणा देती है, सूर्य, जल, पवन, पेड़, पृथ्वी सब कुछ सदैव देने का ही संदेश देते हैं। देश हमें देता है सब कुछ, हम भी तो कुछ देना सीखें, से प्रेरणा लेते हुए सेवा द्वारा हम अपने जीवन को सार्थक करते हए परम सुख की अनुभूति कर सकते हैं। हिन्दू संस्कार में ऐसा मानना है कि गरीबों और असहाय के उत्थान के लिए दान देने से व्यक्ति के पास लक्ष्मी खुद चल कर आती हैं और वह हमेसा प्रसन्न, निरोग और दीर्घायु होता है।`,
        `सेवा भारती सेवा कार्यों की तीन श्रेणियाँ मानती है-
        i. किसी अभावग्रस्थ व्यक्ति का आभाव दूर करना, जैसे भूखे को अन्न देना, प्यासे को पानी देना, बीमार को दवा देना, निरक्षर को शिक्षा देना, इसे तृतीय श्रेणी में रखा गया है। 
        ii. पीड़ित, वंचित लोगों का आभाव दूर करते-करते उनके स्वावलम्बी एवं स्वाभिमानी बनाने को द्वितीय श्रेणी कहा गया है। 
        iii. आज का सेवित (सेवा लेने वाला व्यक्ति) स्वावलम्बी, स्वाभिमानी बनकर कल दूसरों की सेवा करने वाला बने, ऐसा प्रयास करने को प्रथम श्रेणी कहा गया है।
