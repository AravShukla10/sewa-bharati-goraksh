  ...
  const content = {
    en: {
      ...
      paragraphs: [
        ...
        `Seva Bharti believes in three categories of service work:`,
        `1. <strong>First Category</strong>: Making efforts so that the person who is served today becomes self-reliant, self-respecting, and the one who serves others tomorrow.`,
        `2. <strong>Second Category</strong>: Removing the needs of the suffering and deprived people and making them self-reliant and self-respecting.`,
        `3. <strong>Third Category</strong>: Removing the need of a poor person, such as giving food to the hungry, water to the thirsty, medicine to the sick, and education to the illiterate.`,
        `Continuous efforts are made to ensure that most of the service works carried out by Sewa Bharti are of the first class and that they bring about social change.`,
      ],
      categories: [
        {
    ...
    hi: {
      ...
      paragraphs: [
        `<strong>राष्ट्रीय स्वयंसेवक संघ</strong>, सम्पूर्ण हिन्दू समाज को संगठित कर राष्ट्र को परम वैभव पर लाने का कार्य कर रहा है, परंतु अभी भी हिन्दू समाज का वंचित, पीड़ित, उपेक्षित और अभावग्रस्त समाज हमसे दूर है। राष्ट्र विरोधी शक्तियाँ इन्हीं को अपना अस्त्र बनाती है। इसी दृष्टि से संघ ने सेवा विभाग एवं सेवा भारती की रचना कर सेवा के माध्यम से इन्हें अपने समीप लाते हुए, राष्ट्र की मुख्य धारा से जोड़ने का कार्य कर रहा है। सेवा भारती स्वयंसेवकों द्वारा संचालित एक सेवा संगठन है। सेवा भारती विशेष रूप से सेवा बस्तियों में काम करती है जहाँ वंचित, पीड़ित, उपेक्षित, अभावग्रस्त, गरीब और आर्थिक रूप से पिछड़ा समाज रहता है।`,
        ...
        `सेवा भारती सेवा कार्यों की तीन श्रेणियाँ मानती है-`,
        `i. <strong>प्रथम श्रेणी</strong>: आज का सेवित (सेवा लेने वाला व्यक्ति) स्वावलम्बी, स्वाभिमानी बनकर कल दूसरों की सेवा करने वाला बने, ऐसा प्रयास करने को प्रथम श्रेणी कहा गया है।`,
        `ii. <strong>द्वितीय श्रेणी</strong>: पीड़ित, वंचित लोगों का आभाव दूर करते-करते उनके स्वावलम्बी एवं स्वाभिमानी बनाने को द्वितीय श्रेणी कहा गया है।`,
        `iii. <strong>तृतीय श्रेणी</strong>: किसी अभावग्रस्थ व्यक्ति का आभाव दूर करना, जैसे भूखे को अन्न देना, प्यासे को पानी देना, बीमार को दवा देना, निरक्षर को शिक्षा देना, इसे तृतीय श्रेणी में रखा गया है।`,
        `सेवा भारती द्वारा चलाए जाने वाले अधिकतम सेवा कार्य प्रथम श्रेणी के हों और उसके द्वारा सामाजिक परिवर्तन हो यह सतत प्रयास किया जाता है।`,
      ],
      categories: [
        {
      ...
      <div className="content-wrapper">
        ...
        <div className="service-content">
          {content[languageType].paragraphs.map((para, index) => (
            <p key={index} dangerouslySetInnerHTML={createMarkup(para)}></p>
          ))}
        </div>
        ...
        <div className="service-categories">
          {content[languageType].categories.map((category, index) => (
            <div className={`category category-${index + 1}`} key={index}>
              ...
              <h3 dangerouslySetInnerHTML={createMarkup(`<strong>${category.title}</strong>`)}></h3>
