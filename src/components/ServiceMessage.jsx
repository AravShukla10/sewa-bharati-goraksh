  ...
  const content = {
    en: {
      ...
      paragraphs: [
        ...
        `1. **First Category**: Making efforts so that the person who is served today becomes self-reliant, self-respecting, and the one who serves others tomorrow.`,
        `2. **Second Category**: Removing the needs of the suffering and deprived people and making them self-reliant and self-respecting.`,
        `3. **Third Category**: Removing the need of a poor person, such as giving food to the hungry, water to the thirsty, medicine to the sick, and education to the illiterate.`,
    ...
    hi: {
      ...
      paragraphs: [
        ...
        `i. **प्रथम श्रेणी**: आज का सेवित (सेवा लेने वाला व्यक्ति) स्वावलम्बी, स्वाभिमानी बनकर कल दूसरों की सेवा करने वाला बने, ऐसा प्रयास करने को प्रथम श्रेणी कहा गया है।`,
        `ii. **द्वितीय श्रेणी**: पीड़ित, वंचित लोगों का आभाव दूर करते-करते उनके स्वावलम्बी एवं स्वाभिमानी बनाने को द्वितीय श्रेणी कहा गया है।`,
        `iii. **तृतीय श्रेणी**: किसी अभावग्रस्थ व्यक्ति का आभाव दूर करना, जैसे भूखे को अन्न देना, प्यासे को पानी देना, बीमार को दवा देना, निरक्षर को शिक्षा देना, इसे तृतीय श्रेणी में रखा गया है।`,
